...
export function WhatsAppFloat({ whatsapp }: { whatsapp: string }) {
  return (
    <a
      ...
      target="_blank"
      className="fixed bottom-6 right-6 z-50 w-[60px] h-[60px] bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:scale-110 hover:shadow-[0_6px_30px_rgba(37,211,102,0.5)] transition-all"
      aria-label="WhatsApp"
    >
